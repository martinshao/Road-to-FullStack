...
相信这张图大家一定不会陌生，之前关于执行栈和event loop的讲解就和大家见过面，但是这种图中仍然有未解之谜。 对于大括号里面的的部分相信大家非常好奇，其实这是JavaScript代码执行最关键的部分。

这里面首先是内存分配的问题，然后是调用栈中到底发生了什么！

![alt text](../_assets/123123.png "JavaScript call stack ")
